...
from energyworx_client.auth import DEFAULT_API_ROOT
from energyworx_client.auth.external_service import ExternalService
from energyworx_client.parser.tags import parse_tags
from energyworx_client.parser.timeseries import parse_result_df, parse_nested_structure_result_df
...
class EWX(object):
    ...
    def add_tags(self, tags):
        ...
        return self.__execute_and_handle_response(request, asynch=True)
